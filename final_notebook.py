...
bias_files = sorted(glob(os.path.join('/home/aries/NGC2506_3/20211220_DFOT/bias*.fits')))
biaslist = []
print(bias_files)
...
masterbias.write('/home/aries/NGC2506_3/20211220_DFOT/masterbias.fits', overwrite=True)
mbias=ccdproc.CCDData.read('/home/aries/NGC2506_3/20211220_DFOT/masterbias.fits',unit='adu')
...
## We load the flat files here using glob.

flat_files=sorted(glob(os.path.join('/home/aries/NGC2506_3/20211220_DFOT/flat*.fits')))
flatlist=[]
...
masterflat.write('/home/aries/NGC2506_3/20211220_DFOT/masterflat.fits', overwrite=True)
mflat=ccdproc.CCDData.read('/home/aries/NGC2506_3/20211220_DFOT/masterflat.fits',unit='adu')
...
# ### Master bias substraction, master flat division - working
...
start = time.time()
files=sorted(glob(os.path.join('/home/aries/NGC2506_3/20211220_DFOT/NGC2506*.fits')))
...
## Cosmic ray cleaning using lacosmic.
...
#data_0,header_0=fits.getdata(files[0],header=True)
...
def magnitude(data, apperture, an_ap ):
    sigma_clip = SigmaClip(sigma=3, maxiters=10)
    bkg_estimator = SExtractorBackground()    
